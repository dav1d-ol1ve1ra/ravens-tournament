...
SCHEDULE = (
    ...
    match(1, time(16, 55), time(18), 'Court 1', 'GS-B-06 — B2 vs B3', 'group_stage', 'B2', 'B3', '1A', 'GS-B-06', group_code='B'),
    event(1, time(16, 55), time(18), 'Court 3', 'free', 'Free / Buffer'),
    match(1, time(17, 10), time(18), 'Court 2', 'LL-01 — 4A vs 5A', 'lower_league', '4A', '5A', '3A', 'LL-01'),
    match(2, time(9), time(10, 5), 'Court 1', 'LL-03 — 3A vs 4A', 'lower_league', '3A', '4A', '2A', 'LL-03'),
    match(2, time(9), time(10, 5), 'Court 2', 'LL-08 — 5A vs 3B', 'lower_league', '5A', '3B', '1B', 'LL-08'),
    match(2, time(9), time(10, 5), 'Court 3', 'UB-01 — 1A vs 2B', 'upper_semifinal', '1A', '2B', '4B', 'UB-01'),
    match(2, time(10, 5), time(11, 10), 'Court 1', 'LL-09 — 3A vs 5A', 'lower_league', '3A', '5A', '1A', 'LL-09'),
    match(2, time(10, 5), time(11, 10), 'Court 2', 'LL-10 — 3B vs 4B', 'lower_league', '3B', '4B', '4A', 'LL-10'),
    match(2, time(10, 5), time(11, 10), 'Court 3', 'UB-02 — 1B vs 2A', 'upper_semifinal', '1B', '2A', '2B', 'UB-02'),
    match(2, time(11, 10), time(12, 10), 'Court 1', 'LL-02 — 3A vs 3B', 'lower_league', '3A', '3B', '1A', 'LL-02'),
    match(2, time(11, 10), time(12, 10), 'Court 2', 'LL-07 — 4A vs 4B', 'lower_league', '4A', '4B', '5A', 'LL-07'),
    ...
    match(2, time(13, 35), time(14, 35), 'Court 1', 'LL-05 — 4A vs 3B', 'lower_league', '4A', '3B', 'W-UB-01', 'LL-05'),
    match(2, time(13, 35), time(14, 35), 'Court 2', 'LL-06 — 3A vs 4B', 'lower_league', '3A', '4B', 'W-UB-02', 'LL-06'),
    match(2, time(13, 35), time(14, 35), 'Court 3', 'UB-03 — Loser UB-01 vs Loser UB-02', 'upper_third_place', 'L-UB-01', 'L-UB-02', '5A', 'UB-03', home_source_code='UB-01', home_source_outcome='loser', away_source_code='UB-02', away_source_outcome='loser'),
    match(2, time(14, 35), time(15, 40), 'Court 1', 'LL-04 — 5A vs 4B', 'lower_league', '5A', '4B', '3B', 'LL-04'),
    event(2, time(14, 35), time(15, 40), 'Court 2', 'free', 'Free / Buffer'),
    match(2, time(14, 35), time(15, 40), 'Court 3', 'UB-04 — Winner UB-01 vs Winner UB-02', 'upper_final', 'W-UB-01', 'W-UB-02', '4A', 'UB-04', home_source_code='UB-01', home_source_outcome='winner', away_source_code='UB-02', away_source_outcome='winner'),
